...
const ChapterSection = () => {
  ...
  const handleChapterClick = (chapter) => {
    ...
    navigate(
      ...
      { state: { syllabusTitle, syllabusId, bookId, chapterId, activeBook } }
    );
  };
    ...
    <Box sx={{ mt: 0 }}>
      <Box
        sx={{
          ...
          display: "flex",
          alignItems: "center",
          gap: 1.5, // spacing between arrow and title
        }}
      >
        <IconButton
        ...
        >
          <ArrowBackIcon sx={{ fontSize: { xs: 24, sm: 30 } }} />
        </IconButton>
            ...
            >
              <Button
                ...
                sx={{
                  backgroundColor:
                    bookId === book?._id
                      ? theme.syllabus.booksBackground
                      : theme.syllabus.chaptersBackground,
